...
export const HomeWelcomeCard: FC<Props> = ({ title, content }) => {
    return (
        <div className="tw-flex tw-h-full tw-w-full tw-flex-col">
                <div className="tw-absolute tw-top-0 tw-left-0 tw-w-full tw-h-full  tw-opacity-10 tw-flex tw-items-center tw-justify-center tw-text-center tw-text-2xl tw-text-gray-500 tw-px-4">
                {fullTetx}
                </div>
            </div> 
    );
